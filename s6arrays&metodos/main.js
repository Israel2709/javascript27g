...
let testSuma = sumAllNumbers(numbers);
console.log(testSuma);
/*
...
const getFullNames = (usersList) => {
  ...
  for (let i = 0; i < usersList.length; i++) {
    ...
    userLabel = `${userName} ${userLastName}`;
    namesArray.push(userLabel);
    /*
    {
        gender: "female",
        name: {
...
let testObtenerNombres = getFullNames(people);
console.log(testObtenerNombres);
...
let filterTest = filterByNationality(people, "LL");
let filterTest2 = filterByNationality(people, "FR");
