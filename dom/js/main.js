let koders = ["Azael", "May", "Christian", "Manuel"];
...
let paragraphText = document.createTextNode(" Lorem ipsum dolor sit amet.");
...
const printKodersList = (
  kodersArray /*array de datos*/,
  listId /*elemento en el que quiero insertar los koders*/
) => {
  let kodersList =
  ...
  kodersArray.forEach((koder) => {
    ...
    kodersList.appendChild(
      listItem
    ); /*lo insertamso en el nodo de dom que seleccionamos previamente*/
  });
};
...
/*
    1.-Crear una lista en nuestra UI, que muestre los nombres de todos los productos disponibles
    2.- Crear una tabla en nuestra UI, que muestre el nombre, categoría y precio de cada uno de nuestros productos
*/
